...
# ---------------------------------------------------------------------------
# 수당율 공유 — 전용 스프레드시트(config.RATES_SHEET_ID)의 '수당율' 탭
#
# ⚠️ 예전 주석은 '고객관리 스프레드시트' 라고 적혀 있었는데 사실과 다르다.
#    부르는 쪽(main_window.fetch_rates_async / settings_dialog)이 언제나
#    config.RATES_SHEET_ID 를 넘긴다 — 업무자료와 같은 파일이다.
#
