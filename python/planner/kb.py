...
CATEGORIES = ["전자약정", "심사서류", "연락처", "진행절차", "기타"]
CAT_DOCS = "심사서류"        # 서류 체크리스트가 재료로 쓰는 분류

# 처음 켰을 때 화면이 비어 있지 않도록 넣어 두는 예시.
# 실제 내용은 관리자가 [자료 편집] 에서 채운다.
SAMPLE = [
    {
        "category": "심사서류", "finance": "", "title": "개인 심사서류",
        "tags": "개인 직장인 급여소득자",
        "body": "개인(급여소득자) 심사 기본 서류입니다.\n"
                "· 재직 확인이 안 되면 건강보험 자격득실확인서를 함께 받습니다.",
        "checklist": ["신분증 사본", "재직증명서", "소득금액증명원",
                      "건강보험 자격득실확인서", "통장 사본"],
    },
    {
        "category": "심사서류", "finance": "", "title": "개인사업자 심사서류",
        "tags": "사업자 개인사업자",
        "body": "개인사업자 심사 기본 서류입니다.",
        "checklist": ["사업자등록증", "대표자 신분증 사본",
                      "부가세과세표준증명원", "소득금액증명원", "통장 사본"],
    },
    {
        "category": "심사서류", "finance": "", "title": "법인 심사서류",
        "tags": "법인",
        "body": "법인 심사 기본 서류입니다.",
        "checklist": ["사업자등록증", "법인등기부등본", "주주명부",
                      "재무제표(최근 2기)", "법인인감증명서", "사용인감계"],
    },
]
